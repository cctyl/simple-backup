...
public class DeviceUtils {
    ...
    public static String getAndroidId() {
        ...
        return Settings.Secure.getString(AppApplication.getContext().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    public static long getTotalInternalStorageSize() {
        ...
        return (long) statFs.getBlockSizeLong() * statFs.getBlockCountLong();
    }
    ...
    public static long getAvailableInternalStorageSize() {
        StatFs statFs = new StatFs(Environment.getDataDirectory().getPath());
        return (long) statFs.getBlockSizeLong() * statFs.getAvailableBlocksLong();
    }
